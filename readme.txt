...
With this plugin you can define for each page/post whether the title should be suppressed on the homepage, category, archive or detail pages.
...
Mit diesem Plugin kann man bei jeder Seite und jedem Artikel festlegen ob der Titel auf der Startseite, auf Kategorie, Archiv oder Detailseiten unterdrückt werden soll.
